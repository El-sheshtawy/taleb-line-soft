            ...
            <div class="listOfName">
                <div class="d-flex align-items-center justify-content-between gap-2 p-2 text-center position-relative"
                    ...
                    <select id="settingsSelector" class="tabs-selector"
                        ...
                        <option selected value="school-tab" url="{{ route('school.statistics.school') }}">المدرسة
                        </option>
                ...
                <div class="content mt-4">
                    <div class="table-responsive">
                        <div class="card-header bg-dark text-white">
                            <h5 class="card-title mb-0 table-title text-center">
                                متابعة غياب الطلاب بتاريخ {{ $date }}
                            </h5>
                        </div>
                        <table class="table table-bordered align-middle mb-0 general-table">
                            <thead>
                                <tr class="text-center align-middle">
                                    ...
                                    <th class="p-2">غائب</th>
                                    <th class="p-2">حاضر</th>
                            ...
                            <tbody>
                                @foreach ($classes as $class)
                                    <tr>
                                        ...
                                        <td class="p-1 text-center bg-danger text-white">
                                            {{ $class->absent_students }}
                                        </td>
                                        <td class="p-1 text-center bg-success text-white">
                                            {{ $class->students_count - $class->absent_students }}
                                        </td>
                                        <td class="p-1 text-center bg-primary text-white">
                            ...
                            <tfoot>
                                <tr style="background-color: #f8f9fa; font-weight: bold;">
                                    <td colspan="2" class="p-2 text-white" style="background-color: #15336a ">
                                        المجموع الكلى
                                    </td>
                                    <td class="p-2 text-center">{{ $classes->count() }}</td>
                                    <td class="p-2 text-center">{{ $classes->sum('absent_students') }}</td>
                                    <td class="p-2 text-center">
                                        {{ $classes->sum('students_count') - $classes->sum('absent_students') }}
                                    </td>
                                    <td class="p-2 text-center"> {{ $classes->sum('students_count') }} </td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                        ...
                        <thead class="banner-header">
                            ...
                            <tr>
                                <td colspan="100%" style="text-align: center;">
                                    <h1>احصائيات غياب الطلاب بتاريخ ${formattedDate}</h1>
                                </td>
                            </tr>
