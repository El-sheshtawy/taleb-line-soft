<form action="{{ url()->current() }}" method="get" id="dateForm">
    <div class="row">
        {{-- Grade select --}}
        <div class="col-6 col-md-6 d-flex align-items-center gap-2 mb-2">
        ...
        {{-- <div class="col-12 col-md-4 d-flex align-items-center gap-2 mb-2">
            <label for="teacher_id" class="fw-bold text-primary">المعلم:</label>
            <select name="teacher_id" class="form-control" id="student_select" required
                style="font-size:16px;background:#ffd400;border-radius:5px;">
                <option selected disabled value="">اختر المعلم...</option>
...
<script>
    ...
    function getClassStudents(classId) {
        ...
        fetch(`/public/schools/${schoolId}/classes/${classId}/students`)
            .then(response => response.json())
            .then(data => {
