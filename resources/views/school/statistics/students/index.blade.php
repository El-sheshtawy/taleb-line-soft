            ...
            <div class="listOfName">
                <div class="d-flex align-items-center justify-content-between gap-2 p-2 text-center position-relative"
                    ...
                    <select id="settingsSelector" class="tabs-selector"
                        ...
                        <option selected value="students-tab" url="{{ route('school.statistics.students') }}">الطلاب
                        </option>
                ...
                <div class="form-control">
                    @include('school.statistics.students.form')
                </div>

                @include('school.statistics.students.table')
