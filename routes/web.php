...
Route::get('/abc', [\App\Http\Controllers\ReportsController::class, 'index'])->name('reports.index');
...
Route::middleware('auth')->group(function(){
    ...
    Route::post('/teacher/export-pdf', [\App\Http\Controllers\Admin\PdfExportController::class, 'exportTable'])->name('teacher.export-pdf');
